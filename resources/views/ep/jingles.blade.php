<x-app-layout>
    ...
    <div class="table-settings mb-4">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col col-md-6 col-lg-3 col-xl-4">
                <form class="input-group me-2 me-lg-3 fmxw-400" method="GET" action="{{ route('jingles.index') }}">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                @foreach ($jingles as $jingle)
                    ...
                    <!--Delete Modal-->
                    <div class="modal fade" id="modal-delete{{ $jingle->id }}" tabindex="-1" aria-labelledby="modal-default" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <form action="{{ route('jingles.destroy', $jingle->id) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure you want to delete this jingle?</p>
                                    </div>
    ...
    <div class="modal fade" id="modal-default" tabindex="-1" aria-labelledby="modal-default" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="{{ route('jingles.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h2 class="h6 modal-title">Add New Jingle</h2>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-4">
